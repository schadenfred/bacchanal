...
ActiveRecord::Schema.define(version: 20160216073537) do
  ...
  create_table "addresses_addressables", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["address_id"], name: "index_addresses_addressables_on_address_id"
    t.index ["addressable_id", "addressable_type"], name: "addressable"
    t.index ["addressable_id"], name: "index_addresses_addressables_on_addressable_id"
  end
  ...
  create_table "addresses_appellables", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["address_id", "appellation_id"], name: "index_addresses_appellables_on_address_id_and_appellation_id"
  end
  ...
  create_table "articles", force: :cascade do |t|
    ...
    t.index ["org_id"], name: "index_articles_on_org_id"
  ...
  create_table "attachments", force: :cascade do |t|
    ...
    t.index ["attachment_uid"], name: "index_attachments_on_attachment_uid"
  end
  ...
  create_table "buttafly_spreadsheets", force: :cascade do |t|
    ...
    t.index ["user_id"], name: "index_buttafly_spreadsheets_on_user_id"
  end
  ...
  create_table "curations", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["curatable_id", "curatable_type"], name: "index_curations_on_curatable_id_and_curatable_type"
    t.index ["review_id"], name: "index_curations_on_review_id"
  end
  ...
  create_table "identities", force: :cascade do |t|
    ...
    t.string "link"
    t.index ["identifiable_id", "identifiable_type"], name: "index_identities_on_identifiable_id_and_identifiable_type"
  end
  ...
  create_table "orgs", force: :cascade do |t|
    ...
    t.index ["slug"], name: "index_orgs_on_slug"
  end
  ...
  create_table "positions", force: :cascade do |t|
    ...
    t.index ["tenure_end"], name: "index_positions_on_tenure_end"
    t.index ["tenure_start"], name: "index_positions_on_tenure_start"
    t.index ["title", "user_id"], name: "index_positions_on_title_and_user_id"
  ...
  create_table "reviews", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["reviewer_id", "wine_id"], name: "index_reviews_on_reviewer_id_and_wine_id"
  end
  ...
  create_table "slides", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["photo_id", "gallery_id"], name: "index_slides_on_photo_id_and_gallery_id"
  end
